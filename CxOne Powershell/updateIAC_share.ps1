...
function updatePolicies($token, $policyId) {
    ...
    $body = Get-Content -Path "C:\Users\DavidNe\OneDrive - Checkmarx\Documents\CxOne Scripts\response.json"
...
$writeProjectTags = getProjectTags
Write-Output $writeProjectTags
